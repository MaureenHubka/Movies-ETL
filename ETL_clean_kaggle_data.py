...
def function_name():
    ...
    #only keep rows where adult is False, and then drop the "adult" column
    kaggle_metadata = kaggle_metadata[kaggle_metadata['adult'] == 'False'].drop('adult',axis='columns')
    
    ## Convert video by creating Boolean column
    ...
    ## Looking for redunduncy using suffixes 
